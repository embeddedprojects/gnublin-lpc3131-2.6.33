...
static irqreturn_t gnublin_mci_detect_interrupt(int irq, void *data)
{
...
static struct lpc313x_mci_board gnublin_mci_platform_data = {
	.num_slots		= 1,
	.detect_delay_ms	= 250,
	.init 			= mci_init,
	.get_ro			= mci_get_ro,
...
static struct platform_device	lpc313x_mci_device = {
	...
	.dev		= {
		...
		.platform_data		= &gnublin_mci_platform_data,
	},
...
static struct mtd_partition gnublin_nand0_partitions[] = {
...
static struct lpc313x_nand_timing gnublin_nanddev_timing = {
	.ns_trsd	= 36,
	.ns_tals	= 36,
	.ns_talh	= 12,
	.ns_tcls	= 36,
...
static struct lpc313x_nand_dev_info gnublin_ndev[] = {
	{
		.name		= "nand0",
		.nr_partitions	= ARRAY_SIZE(gnublin_nand0_partitions),
		.partitions	= gnublin_nand0_partitions
	}
};

static struct lpc313x_nand_cfg gnublin_plat_nand = {
	.nr_devices	= ARRAY_SIZE(gnublin_ndev),
	.devices	= gnublin_ndev,
	.timing		= &gnublin_nanddev_timing,
	.support_16bit	= 0,
};
...
static struct platform_device	lpc313x_nand_device = {
	...
	.dev		= {
		...
		.coherent_dma_mask	= 0xffffffff,
		.platform_data	= &gnublin_plat_nand,
	},
...
static struct ads7846_platform_data gnublin_ads7846_info = {
	.model			= 7846,
...
static struct lpc313x_spi_chip gnublin_ads7846_chip = {
...
static int __init lpc313x_spidev_register(void)
{
	struct spi_board_info info[] = {
	{
		...
		.bus_num	= 0,
		.chip_select	= 1,
		.platform_data	= &gnublin_ads7846_info,
		.controller_data= &gnublin_ads7846_chip,
		/*
		.irq		= IRQ_PENDOWN,
		*/
	},
...
static struct map_desc gnublin_io_desc[] __initdata = {
	{
...
{
	lpc313x_map_io();
	iotable_init(gnublin_io_desc, ARRAY_SIZE(gnublin_io_desc));
}

#if defined(CONFIG_MACH_GNUBLIN)
MACHINE_START(EA313X, "GNUBLIN")
